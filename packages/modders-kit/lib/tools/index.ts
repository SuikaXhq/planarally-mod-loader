...
import type { LocalPoint } from "../geometry";

export enum ToolNameDefault {
    Select = "Select",
    Pan = "Pan",
    Draw = "Draw",
    Ruler = "Ruler",
...
export type ToolName = ToolNameDefault | string;
...
export interface ITool {
    ...
    onDown: (
        _lp: LocalPoint,
        _event: MouseEvent | TouchEvent | undefined,
        _features: ToolFeatures
    ) => Promise<void>;
    onMove: (
        _lp: LocalPoint,
        _event: MouseEvent | TouchEvent | undefined,
